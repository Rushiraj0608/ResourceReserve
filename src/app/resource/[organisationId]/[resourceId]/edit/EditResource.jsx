      ...
      <form onSubmit={editResource}>
        <div className=" shadow-[0_20px_40px_rgba(0,0,0,0.3)] my-10  bg-white w-10/12 m-auto gap-y-5 p-10 grid grid-cols-3 [&>*]:p-4  [&>*:nth-child(odd)]:bg-green-500 [&>*:nth-child(even)]:col-span-2">
          ...
          <div className="grid grid-cols-2 gap-x-20 gap-y-5 m-5">
            <span>
              <label htmlFor="editResourceReservationLength" className="block">
            ...
            <span>
              ...
              <input
                ...
                onChange={(e) =>
                  setResource({ ...resource, reservationGap: e.target.value })
                }
            ...
            <span className="text-center">
              ...
              />
              <label htmlFor="editResourcePermissionNo" className="ml-5 mr-5">
                no
              </label>
              ...
              />
              <label htmlFor="editResourcePermissionYes" className="ml-5 mr-5">
                yes
              </label>
            </span>
          </div>
